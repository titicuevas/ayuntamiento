 ...
 */
/** Range Control */
class Kindergarten_Playgroup_Range_Slider extends WP_Customize_Control {
    /**
    ...
    public function enqueue() {
        wp_enqueue_style( 'kindergarten_playgroup-range-control-styles', get_parent_theme_file_uri( '/assets/css/range.css' ), false, '1.0.0', 'all' );
        wp_enqueue_script( 'kindergarten_playgroup-range-control-scripts', get_parent_theme_file_uri( '/assets/js/range.js' ), array( 'jquery' ), '1.0.0', true );
    }
    /**
